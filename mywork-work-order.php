<?php
    ...
    $_SESSION['header'] = 'My Work Work Order';
    ...
    $query1 = mysqli_query($con, "SELECT * FROM workorder_problem WHERE u_id = '$user_id' AND (c_date>= '$from_date' AND c_date<= '$to_date') ORDER BY c_date ASC");

    $query2 = mysqli_query($con, "SELECT * FROM total_work_order WHERE u_id = '$user_id' AND (date>= '$from_date' AND date<= '$to_date') ORDER BY date ASC");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <p style=color:red></p>
              <h1 align="center" class="h3 mb-0 text-gray-800"><b><u>Work Order Summary(<?php echo $username;?>)</u></b></h1>
            <div class="dropdown">
  ...
  <div class="modal-content">
   ...
   <div class="modal-body">
    <form method="post" action="update-work-order.php">
        ...
        <input type="submit" name="UpdateTotalInformation1" id="btn_UpdateTotalInformation" value="Update" class="btn btn-primary"/>
   ...
   <div class="modal-body">
    <form method="post" action="update-work-order.php">
       ...
       <input type="hidden" name="UID" id="txtUserID">
        ...
        <input type="submit" name="UpdateInformation1" id="btn_UpdateInformation" value="Update" class="btn btn-primary"/>
	    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
    </form>
   </div>
  </div>
          ...
          <!-- Date Search Form -->
          <div>
           <form method="post" action="mywork-work-order.php">
           ...
           <?php
            ...
            <tr>
               <?php
                ...
                <td hidden><?php echo $tempUserName; ?></td>
                ...
                <td><a class="btn btn-danger btn-circle btn-sm" onclick="return checkDelete()" href="mywork-work-order.php?delTotal=<?php echo $row2['id']; ?>">
           ...
           <?php
            ...
            <tr>
               <?php
                ...
                <td><a class="btn btn-danger btn-circle btn-sm" onclick="return checkDelete()" href="mywork-work-order.php?del=<?php echo $row['id']; ?>">
                <i class="fas fa-trash"></i>
                </a></td>
            </tr>
            <?php } ?>
...
<script>
	$(document).ready(function(){
		$('.btnUpdateWorkOrder').on('click', function(){    
            ...
            $('#datepicker3').val(data[4]);
            $('#UpdateTxtPname').val(data[5]);
            $('#UpdateTxtPid').val(data[6]);
            $('#UpdateTxtProblem').val(data[7]);
		});
