<?php
    ...
    $_SESSION['header'] = 'My Work Charge';
    ...
    $query = mysqli_query($con, "SELECT * FROM charge_problem WHERE u_id = '$user_id' AND (c_date>= '$from_date' AND c_date<= '$to_date') ORDER BY f_id ASC, c_date ASC");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <p style=color:red></p>
              <h1 align="center" class="h3 mb-0 text-gray-800"><b><u>Charge Entry Summary(<?php echo $username;?>)</u></b></h1>
            <div class="dropdown">
    ...
    <form method="post" action="update-charge.php">
       ...
       <input type="hidden" name="UID" id="txtUserID">
	    ...
	    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
          ...
          <!-- Date Search Form -->
          <div>
           <form method="post" action="mywork-charge.php">
           ...
           <?php
            ...
            <tr>
               <?php
                ...
                <td><a class="btn btn-danger btn-circle btn-sm" onclick="return checkDelete()" href="mywork-charge.php?del=<?php echo $row['id']; ?>">
